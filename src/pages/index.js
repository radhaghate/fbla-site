        ...
        <div className="grid grid-cols-3 gap-6 content-center p-10">
          <div data-aos="flip-down" className="card bg-base-100 shadow-xl">
            ...
            <div className="card-body">
              ...
              <p className='text-center'>With OLC<span>&apos;</span>s 1-on-1 tutoring sessions, your child can get 100% of our attention 100% of our time together. This way, we can truly make sure your child is learning the right concepts.</p>
            </div>
          </div>
