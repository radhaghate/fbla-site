  ...
  return (
    <div className='flex flex-col h-screen justify-between'>
      ...
      <hr class="border-2 border-white-700 drop-shadow-xl mx-auto w-1/5 mt-5"/>
        <div className='grid grid-rows-2 grid-cols-6 justify-center align-center align-middle m-auto mt-9 mb-9 ml-60 gap-6'>
          <div className='col-start-1 col-span-2'>
            <div className='bg-sky-900 w-full h-full'>
              ...
              <button
                className="flex justify-center button p-7 bg-sky-800 mt-12 ml-28 rounded-xl text-white text-bold text-xl 
